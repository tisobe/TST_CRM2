...
$sumdat      = "$root_dir_CRM/CRMsummary_test2.dat";
$arcdat      = "$root_dir_CRM/CRMarchive_test2.dat";
...
open GF, $g15dat or print STDERR "$0: Cannot open $g11dat\n";
@gp = <GF>;
...
$txt .= sprintf "                GOES-13 P5 flux (p/cm^2-s-sr-MeV) : %.2f\n",$g13p5o;
$txt .= sprintf "-->\n";
